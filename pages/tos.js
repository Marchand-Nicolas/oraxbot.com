      ...
      <div className={styles.page}>
        ...
        <section className={styles.section}>
          ...
          <ul>
            ...
            <li>
              attempt to reverse engineer any software contained on our ebsite;
            </li>
            <li>
          ...
          <p>
            This will let us to terminate upon violations of any of these
            ...
            <a className="link" href="https://www.termsofservicegenerator.net">
        ...
        <section className={styles.section}>
          <h2>3. Disclaimer</h2>
          <p>
            All the materials on this website are provided &quot;is&quot;. We
            makes no warranties, may it be expressed or implied, therefore
            negates all other warranties. Furthermore, We do not make any
        ...
        <section className={styles.section}>
          <h2>4. Limitations</h2>
          <p>
            We will not be hold accountable for any damages that will arise with
        ...
        <section className={styles.section}>
          ...
          <p>
            ...
            typographical, or photographic errors. We will not promise that any
            of the materials in this website are accurate, complete, or current.
            We may change the materials contained on the website at any time
            without notice. We do not make any commitment to update the
            materials.
          </p>
        </section>
        <section className={styles.section}>
          <h2>6. Links</h2>
          <p>
            We have not reviewed all of the sites linked to the Website and we
            are not responsible for the contents of any such linked site. The
            presence of any link does not imply endorsement by our team of the
        ...
        <section className={styles.section}>
          ...
          <p>
            We may revise our Terms of Use for the website and the discord bot
        ...
        <section className={styles.section}>
          ...
          <p>
            Any claim relating to our website shall be governed by the laws of
        ...
        <section className={styles.section}>
          <h2>9. Privacy</h2>
          <Link href="/privacy">
            <strong className="link">Please read our dedicated page</strong>
          </Link>
        </section>
      </div>
      <Footer />
